...
//		String input_path = args[0] ;
	...
	* @date 2017年11月17日 下午8:32:01
	 */
	private static void GPR_and_Data(String[] Inst, int[] GPR, int[] data, int PC, String OutPutFile, int data_address) {
	...
	* @date 2017年11月17日 下午8:37:38
	 */
	public static void WriteSimulation(String fileName, int[] mem, String temp, String type,int data_address) {
		try {
			// 打开一个写文件器，构造函数中的第二个参数true表示以追加形式写文件
			FileWriter writer = new FileWriter(fileName, true);
			writer.write(temp);
